...
using EcommerceCore.Data.EF;
using EcommerceCore.Data.Entities;
using AutoMapper;
using EcommerceCore.Data.IRepository;
using EcommerceCore.Data.EF.Repository;
using EcommerceCore.Application.Interfaces;
using EcommerceCore.Application.Implementation;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<AppDbContext>(options =>
                ...
                o => o.MigrationsAssembly("EcommerceCore.Data.EF")));
